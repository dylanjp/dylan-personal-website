    ...
    <div className={styles.page}>
      ...
      <div className={styles.tilesContainer}>
        ...
        <div className={styles.tileColumn}>
          <div className={`${styles.profileTile} ${getTileAnimationClasses('profile-picture')}`}>
          ...
          <div className={`${styles.stepTile} ${getTileAnimationClasses('step-counter')}`}>
          ...
          <div className={`${styles.stepTile} ${getTileAnimationClasses('favorite-software')}`}>
        ...
        {/* Middle Column */}
        <div className={styles.tileColumn}>
          <div className={`${styles.aboutTile} ${getTileAnimationClasses('about-me')}`}>
            <h2>{aboutMeTile.title}</h2>
            <p>{aboutMeTile.content}</p>
          </div>

          <div className={`${styles.smashTile} ${getTileAnimationClasses('smash-stats')}`}>
        ...
        {/* Right Column */}
        <div className={styles.tileColumn}>
          <div className={`${styles.pokemonTile} ${getTileAnimationClasses('pokemon-team')}`}>
